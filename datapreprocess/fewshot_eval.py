...
def generate_human_value(captions,n):
    ...
    # set_trace()
    # caption_strings = [f"Please review the following example image descriptions:\n"]
    examples = [
    ...
    # if captions:
    #     caption_strings.append(f""Please respond with only the letter corresponding to your choice.")
...
if __name__ == "__main__":
    ...
    #/home/DATA2/cxh/Eval_data
    #/home/DATA2/cxh/Pathology
    root_directory = "/home/DATA2/cxh/Eval_data"
    blacklist_file = "/home/DATA2/cxh/Eval_data/beachmark_close.json"
    ...
    n=2
    output_val_file = os.path.join(root_directory, "beachmark_close_2shot.json")
    test_size = 0.2  
